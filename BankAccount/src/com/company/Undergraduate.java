...
public class Undergraduate extends Student{
    ...
    public Undergraduate(int StudentID, String FirstName, String LastName, double [] Grades) {
        super(StudentID, FirstName, LastName);
        this.Grades = Grades; // assigns the value of the parameter a to the field of the same name
    }
    ...
    public String toString(){
        ...
        return String.format("Student ID: "+StudentID+", First Name: "+FirstName+", Last Name: "+
                LastName+ ", Average: " + (sum/Grades.length) +
